<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="docko.aspx.vb" Inherits="docko" %>
...
<%--          sessionStorage.setItem("A", a);
          ...
          var tmp = '<%= VB_click() %>';--%>
           ...
           var someValueToPass = a + '~' + document.getElementById("dock_" + a).value + '~' + document.getElementById("stage_" + a).value ;
          __doPostBack('CustomPostBack', someValueToPass);
          alert('Picking No ' + a + ' sudah diproses! Check kembali data Anda!');
        }
